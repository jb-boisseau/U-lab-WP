...
class Registration_Magic
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_rm_login_field_view_sett', 'RM_Login_Manage_Controller', 'view_sett');
        $this->loader->add_action('wp_ajax_rm_login_form_view_sett', 'RM_Login_Manage_Controller', 'view_sett');
